...
for (m in classifiers) {
  ...
  for (k in seq.int(nFolds)) {
    ...
    # save(testError, testAUC, OOBError, OOBAUC, trainTime, OOBTime, testTime, treeStrength, treeCorr, numNodes, bestIdx, params, file = paste0(rerfPath, "RandomerForest/R/Results/2018.02.07/", dataSet, "_2018_02_07.RData"))
  }
}
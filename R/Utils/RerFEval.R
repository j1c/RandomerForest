      ...
      for (k in 1:length(params$prob)) {
        for (i in 1:length(params$sparsity)) {
          for (j in 1:length(params$d)) {
            ...
            forest <- RerF(Xtrain, Ytrain,
              trees = params$trees, mat.options = mat.options, rank.transform = params$rank.transform,
